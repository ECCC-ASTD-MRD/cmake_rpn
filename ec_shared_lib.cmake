...
function(ec_target_rpath_from_libs _target)
   ...
   if(tpath)
      ...
      message(WARNING "Using rpn_target_rpath_from_libs without setting the EC_LIB_INSTALL_PATH property on the target can lead to surprises")
      set(tlocal FALSE)
   endif()
   ...
   message(STATUS "Adding rpath [${rpath}] to target ${_target}")
