...
if (DEFINED EC_INIT_DONE) # Is the initial setup already done
   ...
   if(NOT DEFINED COMPILER_SUITE)
      ...
      if(DEFINED ENV{CRAYPE_VERSION})
         ...
         set(COMPILER_SUITE ${CMAKE_MATCH_1} CACHE STRING "Compiler suite to use for the build")
      ...
      if(DEFINED ENV{CC})
         ...
         set(COMPILER_SUITE "user env defined" CACHE STRING "Compiler suite to use for the build")
      endif()
      if(DEFINED ENV{FC})
   ...
   if(NOT CMAKE_SYSTEM_NAME STREQUAL "CrayLinuxEnvironment")
      ...
      elseif(COMPILER_SUITE STREQUAL "intel")
         find_program(COMPILER_FOUND icc NO_CACHE)
   ...
   set(EC_CI_ENV $ENV{ECCI_ENV_VERSION})
   set(EC_COMP "")
