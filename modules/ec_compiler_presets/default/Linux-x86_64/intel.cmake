...
if(NOT TARGET_PROC)
    if(NOT C_ARCH_SPEC AND NOT Fortran_ARCH_SPEC)
    ...
    set(C_ARCH_SPEC "-march=${TARGET_PROC}")
    if(CMAKE_C_COMPILER_VERSION VERSION_GREATER_EQUAL 2023.2)
        set(Fortran_ARCH_SPEC "-march=${TARGET_PROC}")
    else()
        set(Fortran_ARCH_SPEC "-arch=${TARGET_PROC}")
    endif()
endif()
...
if("Fortran" IN_LIST languages)
    set(CMAKE_Fortran_FLAGS "-convert big_endian -align array32byte -assume byterecl -fp-model source -fpe0 -traceback ${Fortran_ARCH_SPEC}" CACHE STRING "Fortran compiler flags" FORCE)
