...
if("C" IN_LIST languages)
    set(CMAKE_C_FLAGS "-ftree-vectorize -mcpu=${TARGET_PROC}")
...
if("Fortran" IN_LIST languages)
    set(CMAKE_Fortran_FLAGS "-fconvert=big-endian -fcray-pointer -frecord-marker=4 -fno-second-underscore -ffree-line-length-none -finit-real=nan -ftree-vectorize -mcpu=${TARGET_PROC} -fstack-arrays")
    set(CMAKE_Fortran_FLAGS_DEBUG "-Wall -Wextra -fbacktrace -ffpe-trap=invalid,zero,overflow -O0 -g3")
